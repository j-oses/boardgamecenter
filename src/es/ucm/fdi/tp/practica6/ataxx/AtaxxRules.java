...
import es.ucm.fdi.tp.practica6.model.CountingFiniteRectBoard;
...
public class AtaxxRules implements GameRules {
	...
	/**
	 * The evaluator for the intelligent algorithm.
	 */
	...
	public AtaxxRules(int dim) {
		this(dim, 0, new ComplexEvaluator());
	}
	 ...
	 *
	 * @param dim       the dimension of the board.
	 * @param obstacles the number of obstacles.
	 */
	...
	/**
	 * Constructs the AtaxxRules object with a dimension and an AI evaluator.
	 *
	 * @param dim       the dimension.
	 * @param evaluator the evaluator.
	 */
	public AtaxxRules(int dim, AtaxxEvaluator evaluator) {
		this(dim, 0, evaluator);
	}

	/**
	 * Constructs the AtaxxRules object with a dimension, some obstacles and an AI evaluator.
	 *
	 * @param dim       the dimension.
	 * @param obstacles the number of obstacles.
	 * @param evaluator the evaluator.
	 */
	public AtaxxRules(int dim, int obstacles, AtaxxEvaluator evaluator) {
		this.dim = dim;
	...
	/**
	 * @param stan the row/column given
	...
	/**
	 * @param pieces the pieces that have to be set on the board it returns
